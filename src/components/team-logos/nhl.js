...
export function NhlLogo({ height = 80, width = 80 }) {
  return (
    <svg
      height={height} viewBox={'0 0 82.400003 93.5'}
      width={width} xmlns={'http://www.w3.org/2000/svg'}
    >
      <linearGradient
        gradientUnits={'userSpaceOnUse'} id={'a'}
        x1={'.882648'} x2={'10.795352'}
        y1={'41.440008'} y2={'41.440008'}
      >
        <stop offset={'.11'} stopColor={'#fff'} />
        <stop offset={'.24'} stopColor={'#dcdfe1'} />
        <stop offset={'.44'} stopColor={'#a8afb3'} />
        <stop offset={'.54'} stopColor={'#949ca1'} />
      </linearGradient>
      <linearGradient
        gradientUnits={'userSpaceOnUse'} id={'b'}
        x1={'76.919998'} x2={'76.919998'}
        y1={'45.48'} y2={'17.23'}
      >
        <stop offset={'0'} stopColor={'#fff'} />
        <stop offset={'.35'} stopColor={'#fff'} />
        <stop offset={'.56'} stopColor={'#949ca1'} />
        <stop offset={'1'} stopColor={'#949ca1'} />
      </linearGradient>
      <linearGradient
        gradientUnits={'userSpaceOnUse'} id={'c'}
        x1={'3.17'} x2={'41.220001'}
        y1={'77.82'} y2={'77.82'}
      >
        <stop offset={'.15'} stopColor={'#fff'} />
        <stop offset={'.21'} stopColor={'#fafafa'} />
        <stop offset={'.29'} stopColor={'#ebeced'} />
        <stop offset={'.37'} stopColor={'#d2d5d7'} />
        <stop offset={'.45'} stopColor={'#afb5b9'} />
        <stop offset={'.51'} stopColor={'#949ca1'} />
      </linearGradient>
      <linearGradient
        gradientUnits={'userSpaceOnUse'} id={'d'}
        x1={'63.799999'} x2={'18.68'}
        y1={'75.889999'} y2={'11.47'}
      >
        <stop offset={'0'} stopColor={'#949ca1'} />
        <stop offset={'.01'} stopColor={'#99a1a6'} />
        <stop offset={'.12'} stopColor={'#c2c6c8'} />
        <stop offset={'.2'} stopColor={'#dbddde'} />
        <stop offset={'.25'} stopColor={'#e4e5e6'} />
        <stop offset={'.75'} stopColor={'#e4e5e6'} />
        <stop offset={'.8'} stopColor={'#dcdedf'} />
        <stop offset={'.87'} stopColor={'#c7cacd'} />
        <stop offset={'.97'} stopColor={'#a3aaae'} />
        <stop offset={'1'} stopColor={'#949ca1'} />
      </linearGradient>
      <linearGradient id={'e'}>
        <stop offset={'.25'} stopColor={'#fff'} />
        <stop offset={'.34'} stopColor={'#fafafa'} />
        <stop offset={'.45'} stopColor={'#ebeced'} />
        <stop offset={'.57'} stopColor={'#d2d5d7'} />
        <stop offset={'.7'} stopColor={'#afb5b9'} />
        <stop offset={'.79'} stopColor={'#949ca1'} />
      </linearGradient>
      <linearGradient
        gradientUnits={'userSpaceOnUse'} id={'f'}
        x1={'16.27'} x2={'41.220001'}
        y1={'7.3'} y2={'7.3'}
      />
      <linearGradient
        gradientUnits={'userSpaceOnUse'} id={'g'}
        x1={'41.220001'} x2={'80.800003'}
        y1={'68.559998'} y2={'68.559998'}
      >
        <stop offset={'.2'} stopColor={'#fff'} />
        <stop offset={'.33'} stopColor={'#fafbfb'} />
        <stop offset={'.47'} stopColor={'#edeeef'} />
        <stop offset={'.63'} stopColor={'#d7dadc'} />
        <stop offset={'.79'} stopColor={'#b8bdc1'} />
        <stop offset={'.93'} stopColor={'#949ca1'} />
      </linearGradient>
      <linearGradient
        gradientUnits={'userSpaceOnUse'} id={'h'}
        x1={'41.220001'} x2={'66.169998'}
        y1={'7.3'} y2={'7.3'}
      />
      <linearGradient
        gradientUnits={'userSpaceOnUse'} id={'i'}
        x1={'1.67'} x2={'17.530001'}
        y1={'10.54'} y2={'10.54'}
      >
        <stop offset={'.39'} stopColor={'#fff'} />
        <stop offset={'.47'} stopColor={'#fafafa'} />
        <stop offset={'.57'} stopColor={'#ebeced'} />
        <stop offset={'.67'} stopColor={'#d2d5d7'} />
        <stop offset={'.79'} stopColor={'#afb5b9'} />
        <stop offset={'.87'} stopColor={'#949ca1'} />
      </linearGradient>
